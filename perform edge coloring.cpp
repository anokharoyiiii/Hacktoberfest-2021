...
- This algorithm performs edge coloring on a complete graph.
- A complete graph is a graph which has a connecting edge between any pair of vertexes.

- This algorithm takes the input of the number of vertexes.
- Construct a complete graph for v vertex.
